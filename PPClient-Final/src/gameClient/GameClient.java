...
public class GameClient extends Observable {
	...
	public GameClient(String userName, String connectToAddress, FrameHandler handler)
	{
	...
	public void setNewQuestion(Question question)
	{
		...
		fHandler.frame3.gamePane.loadQuestion(question);
	    setChanged();
	...
	public void setAnswerOnQuestion(String answer)
	{
		...
		fHandler.frame3.gamePane.loadQuestion(lastQuestion);
		setChanged();
